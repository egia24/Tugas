  ...
  return (
    <View style={home.container}>
      ...
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>6 Nov 2023</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Suhat</Text>
            <Text style={{ color: 'black', fontSize: 14 }}>Rp20.000</Text>
          </View>
        </View>
      </View>
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>3 Nov 2023</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Image
            source={scooter}
            style={home.icon}
          />
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>UMM kampus 2</Text>
            <Text style={{ color: 'black', fontSize: 14 }}>Rp50.000</Text>
          </View>
        </View>
      </View>
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>2 Nov 2023</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Image
            source={scooter}
            style={home.icon}
          />
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Sigura - gura</Text>
            <Text style={{ color: 'black', fontSize: 14 }}>Rp44.000</Text>
          </View>
        </View>
      </View>
    </View>
