      ...
      <ScrollView>
        <View style={{ marginTop: 10 }}>
          <View style={{ ...styles.imageContainer, paddingHorizontal: 20, marginBottom: 20 }}>
            <Image
              source={{
                uri: 'https://assets-a1.kompasiana.com/items/album/2022/05/30/eren-yeager-1-6294723353e2c32b47142933.jpg',
              }}
              style={{ ...styles.profileImage }}
            />
            <View style={{ marginLeft: 10 }}>
              <Text style={styles.profileName}>Yudistira Samuel Sura</Text>
              <View style={{ alignItems: 'center', flexDirection: 'row', }}>
              <Text style={{ color: 'gold', fontSize: 12, fontWeight: 'bold'}}>Member</Text>
              </View>
            </View>
          </View>
